...
export const RESOURCE_FEATURES: Record<string, ResourceFeature> = {
  ...
  sablier: {
    ...
    category: "premium",
    generator_file:
      "engine/topologies/platform/docker/networking/sablier_container_cycle.star (stub; real generator in tdk-cli-extensions/premium/networking/), engine/topologies/platform/docker/networking/traefik.star",
