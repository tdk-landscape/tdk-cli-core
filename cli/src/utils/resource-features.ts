...
export const RESOURCE_FEATURES: Record<string, ResourceFeature> = {
  ...
  ddd: {
    name: "ddd",
    description:
      "Domain-driven design folder structure (domain/application/infrastructure/presentation) " +
    ...
    category: "premium",
    generator_file:
      "engine/topologies/tilt/generators/vite/helpers.star, engine/topologies/tilt/generators/typescript/backend_tsconfig.star",
  ...
  sablier: {
    ...
    description:
      ...
      "(Premium - requires TDK_LICENSE_KEY; see hasSablierLicense() in extension-fetch.ts)",
    applies_to: ["backend", "frontend"],
    enabled_by_default: false,
    category: "premium",
    generator_file:
      "engine/topologies/platform/docker/networking/sablier_container_cycle.star, engine/topologies/platform/docker/networking/traefik.star",
